...
export class ShadowTextureRenderer {
  ...
  constructor(source, shadowMesh, terrainShadowMesh) {
    ...
    if ( terrainShadowMesh ) this.meshContainer.addChild(terrainShadowMesh);
   ...
   * @type {number}
   */
  get width() { return this.source[MODULE_ID].bounds.width; }

  /**
   * Height of the render texture based on the source dimensions.
   * @type {number}
   */
  get height() { return this.source[MODULE_ID].bounds.height; }
